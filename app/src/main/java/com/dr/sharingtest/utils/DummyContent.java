...
import com.dr.sharingtest.model.ImageGalleryCategoryModel;
import com.dr.sharingtest.model.ImageGallerySubcategoryModel;
...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getDrawerMediaDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "Amplifications", R.string.material_icon_headline));
		list.add(new DummyModel(1, "", "About Us", R.string.material_icon_home));
		return list;
	}
